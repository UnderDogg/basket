    ...
    <div class="col-md-12">
        ...
        <div class="row">
            ...
            <div class="col-sm-8 col-sm-offset-2">
                ...
                @else
                    <p>The following sections are optional. The customer will be required to provide any details not completed here when they click on the application link.</p>
