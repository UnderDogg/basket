...
@section('content')
    ...
    <table class="table table-bordered table-striped table-hover">
        ...
        <tr>
            ...
            <th>{!! Form::select('ext_products_groups', $ext_products_groups, Request::only('ext_products_groups')['ext_products_groups'], ['class' => 'filter form-control']) !!}</th>
        ...
        @forelse($applications as $item)
            <tr>
                ...
                <td>{{ $item->ext_products_groups }}</td>
