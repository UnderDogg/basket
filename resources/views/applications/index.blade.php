...
@section('content')
    ...
    <table class="table table-bordered table-striped table-hover">
        ...
        <tr>
            ...
            <th>{!! Form::select('ext_chosen_finance_product_group', $ext_chosen_finance_product_group, Request::only('ext_chosen_finance_product_group')['ext_chosen_finance_product_group'], ['class' => 'filter form-control']) !!}</th>
