...
@section('content')
    ...
    <h1>Applications
        <div class="btn-group pull-right">
            <a href="{{Request::url()}}/amend-order" class="btn btn-default"{{ $amendmentAvailable == true && Auth::user()->can('amend-orders') ? ' ' : ' disabled' }}"><span class="glyphicon glyphicon-pencil"></span> Amend Order</a>
