...
<link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{asset('image/icons')}}/apple-touch-icon-144x144.png" />
<link rel="apple-touch-icon-precomposed" sizes="60x60" href="{{asset('image/icons')}}/apple-touch-icon-60x60.png" />
<link rel="apple-touch-icon-precomposed" sizes="120x120" href="{{asset('image/icons')}}/apple-touch-icon-120x120.png" />
...
<meta name="msapplication-wide310x150logo" content="{{asset('image/icons')}}/mstile-310x150.png" />
<meta name="msapplication-square310x310logo" content="{{asset('image/icons')}}/}mstile-310x310.png" />