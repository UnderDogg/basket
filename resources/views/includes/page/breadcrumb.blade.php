<ol class="breadcrumb">
    ...
    @if(Request::segment(1))
        ...
        @if($last == true) <li class="active"> @else <li><a href="/{{ Request::segment(1) }}"> @endif
            ...
            @if($override1) {{ $override1 }} @else All {{ str_plural(ucwords(Request::segment(1))) }} @endif
